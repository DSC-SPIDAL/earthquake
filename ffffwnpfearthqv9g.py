...
Namelistcfg1 = ["FFFFcovid", "FFFFeq", "FFFFpre", "FFFFfit", "FFFFlstm", "FFFFsctr", "RunName", "RunComment", "LocalRunName",
                "LocalRunComment", "UseLSTMModel", "UseScienceTransformerModel", "UseTFTModel", "UseModel", "Directoryaddon",
                "CovidofSomeType", "Hydrology", "Earthquake", "GarbageCollect", "GarbageCollectionLimit", "SymbolicWindows",
                "LocationValidationFraction", "RestartValidationSetRunName", "LocationBasedValidation",
                "LocationTrainingfraction", "RestartLocationBasedValidation", "ListofTrainingLocs", "ListofValidationLocs",
                "MappingtoTraining", "MappingtoValidation", "TrainingNloc", "ValidationNloc", "SeparateValandTrainingPlots",
                "Plotsplitsize", "Plotrealnumbers", "ListofTestFIPS", "PlotsOnlyinTestFIPS", "Dumpoutkeyplotsaspics",
                "OutputNetworkPictures", "JournalSimplePrint", "UseRealDatesonplots", "PlotinDL2F", "FONTSIZE", "CustomLoss",
                "InputSource", "InputSourceNumber", "PredSource", "PredSourceNumber", "FuturedPred",
                "SpaceTimeEncodingPropTypes", "SpaceTimeEncodingPropValues", "SpaceTimeEncodingPredTypes",
                "SpaceTimeEncodingPredValues", "Dropearlydata", "NaN", "PLOTNUMBER", "COLABROOTDIR", "APPLDIR", "CHECKPOINTDIR",
                "ScaleProperties", "ConvertDynamicPredictedQuantity", "ConvertDynamicProperties", "GenerateFutures",
                "GenerateSequences", "PredictionsfromInputs", "UseFutures", "Usedaystart", "PopulationNorm",
                "TimeIntervalUnitName", "Dailyunit", "StartDate", "InitialDate", "FinalDate", "SkipDL2F", "CalculateNNSE",
                "PlotPredictions", "Num_Seq", "Tseq"]
Namelistcovid1 = ["ReadJuly2020Covid", "ReadAugust2020Covid", "ReadJan2021Covid", "ReadApril2021Covid", "ReadNov2021Covid",
                  "ReadMay2022Covid", "Read7dayCovid", "RereadMay2020", "UseOLDCovariates", "DemVoting", "RepVoting",
                  "NIHCovariates", "CDSpecial", "RootCasesDeaths"]
Namelisteq1 = ["read1950", "UseEarthquakeEigenSystems", "RundleEigenvectors", "MagnitudeMethod", "numberspecialeqs",
               "Specialuse", "Specialmags", "Specialdepth", "Speciallong", "Speciallat", "Specialdate", "Specialxpos",
               "Specialypos", "Specialeqname", "EQ_Numericaldate", "EarthquakeDateaxis", "addRundleEMA", "RundleLambda",
               "RundleSteps", "InputIndextogenerateEMA", "FirstEMAIndex", "EarthquakeEigenAnalysis",
               "ShowEarthquakeEigencorrels", "Eigenvals", "Eig0coeff", "StoreEigencorrels", "StoreNormingfactor",
               "StoreNormingfactor1", "StoreNormingfactor2", "EarthquakeChi1", "EarthquakeChi2", "EQ_Bestindex",
               "EQ_Besttrailingindex", "EarthquakeImagePlots", "AddSpecialstoSummedplots", "Plottingdelay",
               "PrimaryTrainingvetoquake", "SecondaryTrainingvetoquake", "PrimaryValidationvetoquake",
               "SecondaryValidationvetoquake"]
Namelistpre1 = ["BasicInputTimeSeries", "BasicInputStaticProps", "CalculatedTimeSeries", "DynamicPropertyTimeSeries",
                "InputPropertyNames", "NamespredCalculated", "DynamicNames", "Locationname", "Locationstate",
                "Locationpopulation", "Locationfips", "Locationcolumns", "FIPSintegerlookup", "FIPSstringlookup", "Nloc",
                "NFIPS", "NpropperTime", "NpropperTimeDynamicCalculated", "NpropperTimeDynamic", "NpropperTimeDynamicInput",
                "NpropperTimeStatic", "UseProperties", "RawInputSeqDimension", "TFTExtraTimes", "TseqPred", "Num_SeqPred",
                "Num_SeqExtra", "Predictionnamelookup", "Predictionbasicname", "SymbolicInputSequencesTOT",
                "ReshapedSequencesTOT", "NumTimeSeriesCalculatedBasic", "Npropperseq", "NpropperseqTOT", "Npredperseq",
                "NpredperseqTOT", "NumpredFuturedperTime", "NumTimeSeriesCalculated", "NumpredbasicperTime",
                "NumberofTimeunits", "Num_Time", "FuturedPointer", "QuantityStatisticsNames", "QuantityStatistics",
                "QuantityTakeroot", "NpropperTimeMAX", "LengthFutures", "Futures", "NormedInputStaticProps",
                "NormedDynamicPropertyTimeSeries", "NormedCalculatedTimeSeries", "NewPropertyNameIndex",
                "NewPropertyAverageValuesPointer", "NewNpropperTime", "NewNpropperTimeStatic", "NewNpropperTimeDynamic",
                "NewNormedInputStaticProps", "NewNormedDynamicPropertyTimeSeries", "InputPredictionsbyTime", "Predictionname",
                "Predictionnametype", "Predictionoldvalue", "Predictionnewvalue", "Predictionday", "OriginalNloc",
                "MapLocation", "MappedLocations", "LookupLocations", "MappedNloc", "Property_is_Intensive", "PropertyNameIndex",
                "PredictionNameIndex", "PropertyAverageValuesPointer", "PredictionAverageValuesPointer", "Predictionwgt",
                "RawInputSequences", "RawInputPredictions", "RawInputSequencesTOT", "RawInputPredictionsTOT"]
Namelistfit1 = ["AnalysisOnly", "Restorefromcheckpoint", "Checkpointfinalstate", "inputRunName", "inputCheckpointpostfix",
                "standaloneLSTMrun", "ClassLSTMrun", "UseCustomfit", "UseClassweights", "CustomTraining", "GlobalTrainingLoss",
                "GlobalValidationLoss", "GlobalLoss", "batchperepoch", "GlobalSpacetime", "IncreaseNloc_sample",
                "DecreaseNloc_sample", "OuterBatchDimension", "Nloc_sample", "d_sample", "max_d_sample", "processindex",
                "AnyOldValidation"]
Namelistlstm1 = ["LSTMepochs", "LSTMbatch_size", "LSTMoptimizer", "LSTMactivationvalue", "LSTMrecurrent_activation",
                 "LSTMdropout1", "LSTMrecurrent_dropout1", "LSTMdropout2", "LSTMrecurrent_dropout2", "LSTMSkipInitial",
                 "number_LSTMnodes", "LSTMThirdLayer", "LSTMInitialMLP", "LSTMFinalMLP", "LSTMverbose", "LSTMlearning_rate",
                 "LSTMvalidationfrac", "UsedLSTMvalidationfrac"]
Namelistsctr1 = ["GlobalTimeMask", "SpacetimeforMask", "Transformerepochs", "SkipDL2", "SkipDL2B", "SkipDL2D", "SkipDL2E",
                 "SampleSize", "PredictionTraining", "FullSetValidation", "MaskingOption", "ActivateAttention", "DoubleQKV",
                 "TimeShufflingOnly", "Transformerbatch_size", "Transformervalidationfrac", "UsedTransformervalidationfrac",
                 "Transformeroptimizer", "Transformerverbose", "TransformerOnlyFullAttention", "SpacewiseSecondAttention",
                 "SeparateHeads", "d_model", "d_Attention", "d_qk", "d_intermediateqk", "num_heads", "num_Encoderlayers",
                 "EncoderDropout", "EncoderActivation", "d_EncoderLayer", "d_merge", "d_ffn", "oldencoderversion",
                 "ReuseInputinEncoder", "UseMappedinput", "Takevasinput", "ChopupMatrix", "ChopupNumber"]
...
def printeq(FFFFcfg):
    ...
    for jquake in range(0, FFFFeq.numberspecialeqs):
        iquake = qsort[jquake]
        print(str(iquake) + ' ' + str(FFFFeq.Specialdate[iquake]) + ' ' + str(round(FFFFeq.Specialmags[iquake], 1)) + ' ' +
              FFFFeq.Specialeqname[iquake])


def Addfixedearthquakes(FFFFcfg, plotpointer, graphmin, graphmax, ylogscale=False, quakecolor=None, Dateplot=True,
                        vetoquake=None):
    FFFFeq = FFFFcfg.FFFFeq
...
def GatherUpData(OldInputTimeSeries):
    ...
    print(' Daily Unit ' + str(FFFFcfg.Dailyunit) + ' number of ' + FFFFcfg.TimeIntervalUnitName + ' Units ' + str(
        NewNum_Time) + ' ' +
    ...
    for itime in range(0, NewNum_Time):
        NewInputTimeSeries[itime, :, 0] = AggregateEarthquakes(FFFFcfg, Skipped + itime * FFFFcfg.Dailyunit, 0,
                                                               FFFFcfg.Dailyunit, FFFFpre.Nloc,
                                                               FFFFpre.BasicInputTimeSeries[:, :, 0], 0)
        NewInputTimeSeries[itime, :, 1] = AggregateEarthquakes(FFFFcfg, Skipped + itime * FFFFcfg.Dailyunit, 0,
                                                               FFFFcfg.Dailyunit, FFFFpre.Nloc,
                                                               FFFFpre.BasicInputTimeSeries[:, :, 1], 1,
                                                               weighting=FFFFpre.BasicInputTimeSeries[:, :, 0])
        NewInputTimeSeries[itime, :, 2] = AggregateEarthquakes(FFFFcfg, Skipped + itime * FFFFcfg.Dailyunit, 0,
                                                               FFFFcfg.Dailyunit, FFFFpre.Nloc,
                                                               FFFFpre.BasicInputTimeSeries[:, :, 2], 2)
        NewInputTimeSeries[itime, :, 3] = AggregateEarthquakes(FFFFcfg, Skipped + itime * FFFFcfg.Dailyunit, 0,
                                                               FFFFcfg.Dailyunit, FFFFpre.Nloc,
...
def ReadEarthquakeData(FFFFcfg):
    ...
    print(
        ' Pixels ' + str(FFFFpre.Nloc) + ' x dimension ' + str(Nlocaxislengths[0]) + ' y dimension ' + str(Nlocaxislengths[1]))
    ...
    FFFFpre.BasicInputTimeSeries = np.empty([FFFFpre.Num_Time, FFFFpre.Nloc, FFFFpre.NpropperTimeDynamicInput],
                                            dtype=np.float32)
    ...
    for iquake in range(0, FFFFeq.numberspecialeqs):
        ...
        line += str(round(FFFFeq.Speciallong[iquake], 2)) + ' ' + str(
            round(FFFFeq.Speciallong[iquake], 2)) + ' ' + np.datetime_as_string(FFFFeq.Specialdate[iquake])
    ...
    if FFFFcfg.Dailyunit != 1:
        ...
        FFFFpre.BasicInputTimeSeries, FFFFpre.NumberofTimeunits, FFFFpre.Num_Time, FFFFcfg.InitialDate, FFFFcfg.FinalDate = GatherUpData(
            FFFFpre.BasicInputTimeSeries)
        current_time = timenow()
        print(
            startbold + startred + current_time + ' Data unit changed ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
        ...
        for idate in range(0, FFFFpre.Num_Time):
            FFFFeq.EarthquakeDateaxis[idate] = FFFFeq.EarthquakeDateaxis[idate] + np.timedelta64(int(FFFFcfg.Dailyunit / 2),
                                                                                                 'D')
        ...
        if ReadFaultMethod == 1:
            ...
            for nextrow in csv_reader:
                if len(nextrow) != Numberxpixels:
                    printexit('EXIT: Incorrect row length Fault Label Data ' + str(iloc) + ' ' + str(len(nextrow)) + ' ' + str(
                        Numberxpixels))
    ...
    if NumFaultLabels == 1:
        ...
        FFFFpre.BasicInputStaticProps[:, 0] = remapfaults(RawFaultData, Numberxpixels, Numberypixels, sfcurvelist).astype(
            np.float32)
        ...
        FFFFpre.BasicInputStaticProps[:, 1] = remapfaults(RawFaultData, Numberxpixels, Numberypixels, sfcurvelist2).astype(
            np.float32)
        sfcurvelist3 = []
        for yloc in range(0, Numberypixels):
            for xloc in range(0, Numberxpixels):
        ...
        FFFFpre.BasicInputStaticProps[:, 2] = remapfaults(RawFaultData, Numberxpixels, Numberypixels, sfcurvelist3).astype(
            np.float32)
        sfcurvelist4 = []
        for yloc in range(0, Numberypixels):
            for xloc in range(0, Numberxpixels):
        ...
        FFFFpre.BasicInputStaticProps[:, 3] = remapfaults(RawFaultData, Numberxpixels, Numberypixels, sfcurvelist4).astype(
            np.float32)
    ...
    FFFFpre.DynamicNames = ['Magnitude Now', 'Depth Now', 'Multiplicity Now', 'Mult >3.29 Now', 'Mag 2/3 Month Back',
    ...
    if FFFFcfg.Dailyunit == 14:
        FFFFpre.DynamicNames = ['Magnitude 2 weeks Now', 'Depth 2 weeks Now', 'Multiplicity 2 weeks Now',
        ...
        if FFFFeq.addRundleEMA != 0:
            for i in range(0, FFFFeq.addRundleEMA):
                FFFFpre.DynamicNames.append(
                    'MultEMA' + str(FFFFeq.RundleSteps[i]) + ' L' + str(round(FFFFeq.RundleLambda[i], 2)))
    ...
    FFFFpre.NamespredCalculated = ['Mag 2/3 Month Ahead', 'Mag 1.5 Month Ahead', 'Mag 3 Months Ahead', 'Mag 6 Months Ahead',
    ...
    if FFFFcfg.Dailyunit == 14:
        FFFFpre.NumTimeSeriesCalculatedBasic = 9
        FFFFpre.NumTimeSeriesCalculated = 2 * FFFFpre.NumTimeSeriesCalculatedBasic + 1
        FFFFpre.NamespredCalculated = ['Mag 4 Weeks Ahead', 'Mag 2 Month Ahead', 'Mag 3 Months Ahead', 'Mag 6 Months Ahead',
    ...
    for icalc in range(0, FFFFpre.NumTimeSeriesCalculatedBasic):
        ...
        for itime in range(0, FFFFpre.Num_Time):
            FFFFeq.MagnitudeMethod = 0
            FFFFpre.CalculatedTimeSeries[itime, :, icalc] = AggregateEarthquakes(FFFFcfg, itime, Unitdelays[icalc],
                                                                                 Unitjumps[icalc], FFFFpre.Nloc,
                                                                                 FFFFpre.BasicInputTimeSeries[:, :, 0], 0)
            FFFFeq.MagnitudeMethod = MagnitudeMethodTransform
            FFFFpre.CalculatedTimeSeries[itime, :, newicalc] = TransformMagnitude(FFFFcfg,
                                                                                  FFFFpre.CalculatedTimeSeries[itime, :, icalc])
            FFFFeq.MagnitudeMethod = 0
        current_time = timenow()
        print(startbold + startred + 'FFFFcfg.Earthquake ' + str(icalc) + ' ' + FFFFpre.NamespredCalculated[
            icalc] + ' ' + current_time + ' ' + FFFFcfg.RunName + resetfonts)
        print(startbold + startred + 'FFFFcfg.Earthquake ' + str(newicalc) + ' ' + FFFFpre.NamespredCalculated[
            newicalc] + ' ' + current_time + ' ' + FFFFcfg.RunName + resetfonts)
    FFFFeq.MagnitudeMethod = MagnitudeMethodTransform
    FFFFpre.CalculatedTimeSeries[:, :, FFFFpre.NumTimeSeriesCalculatedBasic] = TransformMagnitude(FFFFcfg,
                                                                                                  FFFFpre.BasicInputTimeSeries[
                                                                                                  :, :, 0])
    FFFFeq.MagnitudeMethod = 0
    print(startbold + startred + 'FFFFcfg.Earthquake ' + str(FFFFpre.NumTimeSeriesCalculatedBasic) + ' ' +
          FFFFpre.NamespredCalculated[
              FFFFpre.NumTimeSeriesCalculatedBasic] + ' ' + current_time + ' ' + FFFFcfg.RunName + resetfonts)
    ...
    FFFFcfg.StartDate = np.datetime64(FFFFcfg.InitialDate).astype('datetime64[D]') + np.timedelta64(int(FFFFcfg.Dailyunit / 2),
                                                                                                    'D')
...
def histogrammultiplicity(FFFFcfg, Type, numbins, Data):
    ...
    plt.title('\n'.join(
        wrap(FFFFcfg.RunComment + ' ' + FFFFcfg.RunName + ' ' + Type + ' FFFFcfg.Earthquake Count per location ', 70)))
...
def plotquakeregions(FFFFcfg, HalfSize, xaxisdates, SetofPlots, Commontitle, ylabel, SetofColors, Startx, ncols):
    ...
    for jquake in range(0, FFFFeq.numberspecialeqs):
        ...
        ascii = ''
        if FFFFeq.Specialuse[iquake]:
            ascii = np.datetime_as_string(FFFFeq.Specialdate[iquake]) + ' ' + str(round(FFFFeq.Specialmags[iquake], 1)) + ' ' + \
                    FFFFeq.Specialeqname[iquake]
...
def EarthquakeEigenAnalysis(FFFFcfg):
        ...
        for mastereig in range(0, UseTopEigenTotal):
            ...
            for ieig in range(0, UseTopEigenTotal):
                ...
                if ieig == mastereig:
                    alpha = 0.5
                    width = 1
                ax.plot(FFFFeq.EarthquakeDateaxis[26:], np.power(FFFFeq.StoreEigencorrels[26:, mastereig, ieig], 2),
    ...
    ax.plot(FFFFeq.EarthquakeDateaxis[26:], 0.5 + np.minimum(Maxeig, FFFFeq.EQ_Bestindex[26:]), 'o', color='black',
            markersize=1)
    ax.plot(FFFFeq.EarthquakeDateaxis[26:], np.minimum(Maxeig, FFFFeq.EQ_Besttrailingindex[26:]), 'o', color='red',
            markersize=1)
...
def EndofEarthquake(FFFFcfg):
    ...
    FFFFpre.DynamicPropertyTimeSeries = np.empty([FFFFpre.Num_Time, FFFFpre.Nloc, FFFFpre.NpropperTimeDynamic],
                                                 dtype=np.float32)
    ...
    for iprop in range(0, FFFFpre.NpropperTimeDynamic):
        ...
        if iprop >= FFFFpre.NpropperTimeDynamic - FFFFeq.addRundleEMA:  # Rundle EMA 15-->18
            ...
            for iloc in range(0, FFFFpre.Nloc):
                localEMA = MakeEMAMinCT(FFFFpre.BasicInputTimeSeries[:, iloc, FFFFeq.InputIndextogenerateEMAs],
                                        FFFFeq.RundleSteps[EMANumber], FFFFeq.RundleLambda[EMANumber])
            ...
            print('Dynamic ' + str(iprop) + ' Rundle EMA ' + str(EMANumber) + ' Prop ' + FFFFpre.DynamicNames[
                ...
                for itime in range(0, FFFFpre.NumberofTimeunits):
                    for iloc in range(0, FFFFpre.Nloc):
                        ...
                        if np.math.isnan(localval):
                            ...
                            CountNaN[iprop] += 1
                        FFFFpre.DynamicPropertyTimeSeries[itime, iloc, iprop] = localval
                print('Dynamic ' + str(iprop) + ' Input Time Series ' + str(iprop) + ' Prop ' + FFFFpre.DynamicNames[
                    iprop] + ' Time Shift ' + str(addtime) + ' NaN ' + str(CountNaN[iprop]) + ' Could be in Pred same name')

            else:
                if iprop < (
                        FFFFpre.NpropperTimeDynamic - 6 - FFFFeq.addRundleEMA):  # Transformed Magnitude Dynamic 4-8 from Calc 0 to 4
                ...
                for itime in range(0, FFFFpre.NumberofTimeunits):
                    for iloc in range(0, FFFFpre.Nloc):
                        ...
                        if np.math.isnan(localval):
                            ...
                            CountNaN[iprop] += 1
                        FFFFpre.DynamicPropertyTimeSeries[itime, iloc, iprop] = localval
                print('Dynamic ' + str(iprop) + ' Calc ' + str(icalc) + ' Prop ' + FFFFpre.DynamicNames[
                    iprop] + ' Time Shift ' + str(addtime) + ' NaN ' + str(CountNaN[iprop]) + ' Pred ' +
                      FFFFpre.NamespredCalculated[icalc])
    ...
    for iprop in range(0, FFFFpre.NumTimeSeriesCalculated):
        NewCalculatedTimeSeries[:, :, iprop] = FFFFpre.CalculatedTimeSeries[SkipTimeUnits:FFFFpre.Num_Time + SkipTimeUnits, :,
                                               iprop]
    if FFFFeq.addRundleEMA > 0:
        for iEMA in range(0, FFFFeq.addRundleEMA):
            NewCalculatedTimeSeries[:, :, iEMA + FFFFpre.NumTimeSeriesCalculated] = FFFFpre.DynamicPropertyTimeSeries[:, :,
                                                                                    iEMA + FFFFeq.FirstEMAIndex]
    ...
    dayrange = np.timedelta64(FFFFcfg.Dailyunit, 'D')
    FFFFcfg.StartDate = np.datetime64(FFFFcfg.InitialDate).astype('datetime64[D]') + np.timedelta64(
        FFFFcfg.Tseq * FFFFcfg.Dailyunit + int(FFFFcfg.Dailyunit / 2), 'D')
    FFFFeq.EQ_Numericaldate = np.empty(FFFFeq.numberspecialeqs, dtype=np.int32)
    for iquake in range(0, FFFFeq.numberspecialeqs):
        FFFFeq.EQ_Numericaldate[iquake] = max(0, math.floor((FFFFeq.Specialdate[iquake] - FFFFcfg.StartDate) / dayrange))
    ...
    current_time = timenow()
    print(
        startbold + startred + 'Finish Basic FFFFcfg.Earthquake Setup ' + current_time + ' ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
    ...
    for transformedpointer in range(0, 2):
        ...
        for plotdays in range(0, Numdates):
            ...
            if transformedpointer == 0:
                ...
                InputTitles.append(
                    'Day ' + str(dayindexvalue) + ' ' + ActualDate.strftime("%d/%m/%Y") + ' ' + FFFFpre.InputPropertyNames[
                        FFFFpre.NpropperTimeStatic] + ' max/min '
            ...
            for localplot in range(localplot1, localplot2):
                ...
                InputTitles.append(
                    'Day ' + str(dayindexvalue) + ' ' + ActualDate.strftime("%d/%m/%Y") + ' ' + FFFFpre.NamespredCalculated[
                        localplot] + ' max/min '
                    + str(round(localmax1, 3)) + ' ' + str(round(localmin1, 3)))
...
def ReadHydrologyData(FFFFcfg):
    ...
    !tar
    xjf / content / gdrive / 'My Drive' / 'Colab Datasets' / FFFFcfg.Hydrology / data.tar.bz2 - C / content / gdrive / 'My Drive' / 'Colab Datasets' / FFFFcfg.Hydrology
    import json
    ...
    print(FFFFcfg.InitialDate.strftime("%d/%m/%Y") + ' To ' + FFFFcfg.FinalDate.strftime("%d/%m/%Y") + ' days ' + str(
        FFFFpre.NumberofTimeunits) + ' Locations ' + str(FFFFpre.Nloc))
    ...
    FFFFpre.BasicInputTimeSeries = np.reshape(FFFFpre.BasicInputTimeSeries,
                                              [FFFFpre.NumberofTimeunits, FFFFpre.Nloc, NuminputSeries - 2])
...
def ReadApril2021CovidData(FFFFcfg):
    ...
    if FFFFcovid.ReadNov2021Covid:
        ...
        FFFFpre.NumberofTimeunits = (FFFFcfg.FinalDate - FFFFcfg.InitialDate).days + 1
        print("Total number of Days November 2021 Dataset " + str(FFFFpre.NumberofTimeunits) + ' Dropping at start ' + str(
            FFFFcfg.Dropearlydata))
        ...
        if FFFFcovid.Read7dayCovid:
            ...
            FFFFpre.NumberofTimeunits = (FFFFcfg.FinalDate - FFFFcfg.InitialDate).days + 1
            print("Total number of Days 7 day Dataset " + str(FFFFpre.NumberofTimeunits) + ' Dropping at start ' + str(
                FFFFcfg.Dropearlydata))
            ...
            if FFFFcfg.Dropearlydata < 0:
                printexit('Illegal start date ' + str(FFFFcfg.Dropearlydata))
            FFFFpre.NumberofTimeunits = (FFFFcfg.FinalDate - FFFFcfg.InitialDate).days + 1
            print("Total number of Days May 2022 Dataset " + str(FFFFpre.NumberofTimeunits) + ' Dropping at start ' + str(
                FFFFcfg.Dropearlydata))
        ...
        FFFFpre.NumberofTimeunits = (FFFFcfg.FinalDate - FFFFcfg.InitialDate).days + 1
        print("Total number of Days April 2021 Dataset " + str(FFFFpre.NumberofTimeunits) + ' Dropping at start ' + str(
            FFFFcfg.Dropearlydata))
    ...
    with open(CasesFile, 'r') as read_obj:
        ...
        if (FFFFcfg.InitialDate - TargetDate).days != FFFFcfg.Dropearlydata:
            printexit('Incorrect cases initial date ' + str(FFFFcfg.Dropearlydata) + ' ' + str(TargetDate) + ' ' + str(
                FFFFcfg.InitialDate))
    ...
    with open(DeathsFile, 'r') as read_obj:
        ...
        TargetDate = datetime.strptime(header[1], hformat)
        if (FFFFcfg.InitialDate - TargetDate).days != FFFFcfg.Dropearlydata:
            printexit('Incorrect deaths initial date ' + str(FFFFcfg.Dropearlydata) + ' ' + str(TargetDate) + ' ' + str(
                FFFFcfg.InitialDate))
    ...
    for iloc in range(0, FFFFpre.NFIPS):
        if FFFFcovid.DemVoting[iloc] >= 0.0:
            continue
        print(str(iloc) + ' Missing Votes ' + str(FFFFpre.Locationfips[iloc]) + ' ' + FFFFpre.Locationname[iloc] + ' ' +
              FFFFpre.Locationstate[iloc] + ' pop ' + str(FFFFpre.Locationpopulation[iloc]))
    ...
    FFFFpre.InputPropertyNames = [] * FFFFpre.NpropperTime
    FFFFpre.Property_is_Intensive = np.full(FFFFpre.NpropperTime, True, dtype=bool)
    print('Initial Date ' + str(FFFFcfg.InitialDate) + ' Final Date ' + str(
        FFFFcfg.FinalDate) + ' FFFFpre.NpropperTimeStatic ' + str(
        FFFFpre.NpropperTimeStatic) + ' FFFFpre.NpropperTimeDynamic ' + str(FFFFpre.NpropperTimeDynamic))
...
def ReadJan2021CovidData(FFFFcfg):
    ...
    FFFFpre.NumberofTimeunits = (FFFFcfg.FinalDate - FFFFcfg.InitialDate).days + 1
    print("Total number of Days January 2021 Dataset " + str(FFFFpre.NumberofTimeunits) + ' Dropping at start ' + str(
        FFFFcfg.Dropearlydata))
...
def ReadAugust2020CovidData(FFFFcfg):
    ...
    FFFFpre.NumberofTimeunits = (FFFFcfg.FinalDate - FFFFcfg.InitialDate).days + 1
    print("Total number of Days August Dataset " + str(FFFFpre.NumberofTimeunits) + ' Dropping at start ' + str(
        FFFFcfg.Dropearlydata))
...
if FFFFcovid.RereadMay2020:
    ...
    FFFFpre.NumberofTimeunits = (FFFFcfg.FinalDate - FFFFcfg.InitialDate).days + 1
    print("Total number of Days May Dataset " + str(FFFFpre.NumberofTimeunits) + ' Dropping at start ' + str(
        FFFFcfg.Dropearlydata))
    ...
    if not FFFFcovid.NIHCovariates:
        ...
        with open(CovariatesFile, 'r') as read_obj:
            ...
            if len(header) != (throwaway + FFFFpre.NpropperTimeStatic):
                printexit(
                    'EXIT: Incorrect property header length ' + str(len(header)) + ' ' + str(2 + FFFFpre.NpropperTimeStatic))
            FFFFpre.InputPropertyNames[:] = header[throwaway:]

            iloc = 0
            for nextrow in csv_reader:
                if len(nextrow) != (throwaway + FFFFpre.NpropperTimeStatic):
                    printexit('EXIT: Incorrect row length ' + str(iloc) + ' ' + str(2 + FFFFpre.NpropperTimeStatic) + ' ' + str(
                        len(nextrow)))
                localfips = int(nextrow[0])
...
def ProcessNIHCovariates(FFFFcfg):
        ...
        if FFFFcovid.ReadMay2022Covid:
            if FFFFcovid.Read7dayCovid:
                ...
                Propfilenames = ["Age Distribution.csv", "Air Pollution.csv", "Co-morbidities.csv", "Pop Demographics.csv",
                                 ...
                                 "Vaccination.csv", "VaccinationOneDose.csv", "NOFILE"]
    ...
    for ifiles in range(0, numberfiles):
        ...
        with open(DynamicPropFile, 'r') as read_obj:
            ...
            for nextrow in csv_reader:
                if len(nextrow) != FFFFpre.NumberofTimeunits + skip - enddifference1 - tdelta:
                    printexit(
                        'EXIT: Incorrect row length ' + Propnames[ifiles] + ' Location ' + str(iloc) + ' ' + str(len(nextrow)))
                ...
                for itime in range(FinalTimeIndex, FFFFpre.NumberofTimeunits):
                    FFFFpre.DynamicPropertyTimeSeries[itime, jloc, ifiles] = FFFFpre.DynamicPropertyTimeSeries[
                        itime - 7, jloc, ifiles]
                iloc += 1
        ...
        if tdelta <= 0:
            print('Read ' + Propnames[ifiles] + ' data for locations ' + str(FFFFpre.Nloc) + ' Time Steps ' + str(
                FFFFpre.Num_Time) + ' Days dropped at start ' + str(-tdelta))
        else:
            print('Read ' + Propnames[ifiles] + ' data for locations ' + str(FFFFpre.Nloc) + ' Time Steps ' + str(
                FFFFpre.Num_Time) + ' zero value Days added at start ' + str(tdelta))
...
def ProcessExtensiveProperties(FFFFcfg):
    ...
    if FFFFpre.NpropperTimeStatic > 0:
        ...
        for iloc in range(0, FFFFpre.Nloc):
            for iprop in range(0, FFFFpre.NpropperTimeStatic):
                if not FFFFpre.Property_is_Intensive[iprop]:
                    FFFFpre.BasicInputStaticProps[iloc, iprop] = np.sqrt(
                        FFFFpre.BasicInputStaticProps[iloc, iprop] / FFFFpre.Locationpopulation[iloc])
                else:
...
def ScaleStaticDynamicProperties(FFFFcfg):
    ...
    for iprop in range(0, FFFFpre.NpropperTimeMAX):
        if FFFFpre.QuantityTakeroot[iprop] >= 2:
            if iprop < FFFFpre.NpropperTimeStatic:
                for iloc in range(0, FFFFpre.Nloc):
                    FFFFpre.BasicInputStaticProps[iloc, iprop] = SetTakeroot(FFFFpre.BasicInputStaticProps[iloc, iprop],
                                                                             FFFFpre.QuantityTakeroot[iprop])
            elif iprop < FFFFpre.NpropperTime:
                for itime in range(0, FFFFpre.NumberofTimeunits):
                    for iloc in range(0, FFFFpre.Nloc):
                        FFFFpre.DynamicPropertyTimeSeries[itime, iloc, iprop - FFFFpre.NpropperTimeStatic] = SetTakeroot(
                            FFFFpre.DynamicPropertyTimeSeries[itime, iloc, iprop - FFFFpre.NpropperTimeStatic],
                            FFFFpre.QuantityTakeroot[iprop])
            else:
                for itime in range(0, FFFFpre.NumberofTimeunits):
                    for iloc in range(0, FFFFpre.Nloc):
                        FFFFpre.CalculatedTimeSeries[itime, iloc, iprop - FFFFpre.NpropperTime] = SetTakeroot(
                            FFFFpre.CalculatedTimeSeries[itime, iloc, iprop - FFFFpre.NpropperTime],
                            FFFFpre.QuantityTakeroot[iprop])
    ...
    if FFFFpre.NpropperTimeStatic > 0:
        ...
        for iloc in range(0, FFFFpre.Nloc):
            FFFFpre.NormedInputStaticProps[iloc, :] = np.multiply((FFFFpre.BasicInputStaticProps[iloc, :] - min_value[:]),
                                                                  normval[:])
    ...
    if (FFFFpre.NpropperTimeDynamic > 0) or (FFFFpre.NumTimeSeriesCalculated > 0):
        for iprop in range(FFFFpre.NpropperTimeStatic, FFFFpre.NpropperTimeStatic + FFFFpre.NpropperTimeDynamic):
            FFFFpre.QuantityStatistics[iprop, :] = DynamicPropertyScaling(
                FFFFpre.DynamicPropertyTimeSeries[:, :, iprop - FFFFpre.NpropperTimeStatic])
        for iprop in range(0, FFFFpre.NumTimeSeriesCalculated):
            FFFFpre.QuantityStatistics[iprop + FFFFpre.NpropperTime, :] = DynamicPropertyScaling(
                FFFFpre.CalculatedTimeSeries[:, :, iprop])

        FFFFpre.NormedDynamicPropertyTimeSeries = np.empty_like(FFFFpre.DynamicPropertyTimeSeries)
        for iprop in range(FFFFpre.NpropperTimeStatic, FFFFpre.NpropperTimeStatic + FFFFpre.NpropperTimeDynamic):
            FFFFpre.NormedDynamicPropertyTimeSeries[:, :, iprop - FFFFpre.NpropperTimeStatic] = np.multiply(
                (FFFFpre.DynamicPropertyTimeSeries[:, :, iprop - FFFFpre.NpropperTimeStatic]
        ...
        if FFFFpre.NumTimeSeriesCalculated > 0:
            ...
            for iprop in range(FFFFpre.NpropperTime, FFFFpre.NpropperTimeMAX):
                FFFFpre.NormedCalculatedTimeSeries[:, :, iprop - FFFFpre.NpropperTime] = np.multiply(
                    (FFFFpre.CalculatedTimeSeries[:, :, iprop - FFFFpre.NpropperTime]
                     - FFFFpre.QuantityStatistics[iprop, 0]), FFFFpre.QuantityStatistics[iprop, 2])
            FFFFpre.CalculatedTimeSeries = None
    ...
    for iprop in range(0, FFFFpre.NpropperTimeMAX):
        if iprop == FFFFpre.NpropperTimeStatic:
            print('\n')
        line = startbold + startpurple + str(iprop) + ' ' + FFFFpre.InputPropertyNames[iprop] + resetfonts + ' Root ' + str(
            FFFFpre.QuantityTakeroot[iprop])
        for propval in range(0, 7):
...
print('Static Properties ', FFFFpre.NpropperTimeStatic, ' Total Number of Basic Properties Static+Dynamic ',
      FFFFpre.NpropperTime, ' Number of additional Calculated Properties ', FFFFpre.NumTimeSeriesCalculated,
      ' Absolute Total Properties ', FFFFpre.NpropperTimeMAX)
...
def MapLocationsforEarthquakes(FFFFcfg):
    ...
    MappedDynamicPropertyTimeSeries = np.empty([FFFFpre.Num_Time, FFFFpre.MappedNloc, FFFFpre.NpropperTimeDynamic],
                                               dtype=np.float32)
    MappedNormedInputStaticProps = np.empty([FFFFpre.MappedNloc, FFFFpre.NpropperTimeStatic], dtype=np.float32)
    MappedCalculatedTimeSeries = np.empty([FFFFpre.Num_Time, FFFFpre.MappedNloc, FFFFpre.NumTimeSeriesCalculated],
                                          dtype=np.float32)
...
def RequestPropsandPreds(FFFFcfg):
    ...
    if FFFFcfg.Earthquake:
        ...
        FFFFcfg.SpaceTimeEncodingPropTypes = ['Spatial', 'TopDown', 'TopDown', 'TopDown', 'TopDown', 'TopDown', 'BottomUp',
                                              'BottomUp', 'BottomUp', 'BottomUp']
        FFFFcfg.SpaceTimeEncodingPropValues = [0, 0, 1, 2, 3, 4, 8, 16, 32, 64]

        FFFFcfg.SpaceTimeEncodingPredTypes = ['Spatial', 'TopDown', 'TopDown', 'TopDown', 'TopDown', 'TopDown', 'BottomUp',
                                              'BottomUp', 'BottomUp', 'BottomUp']
    ...
    if FFFFcovid.ReadApril2021Covid:
        ...
        FFFFcfg.SpaceTimeEncodingPredTypes = Types = ['Spatial', 'TopDown', 'TopDown', 'TopDown', 'TopDown', 'TopDown',
                                                      'Weekly']
...
def SetPropsandPreds(FFFFcfg):
    ...
    if (not FFFFcovid.ReadJuly2020Covid) and not FFFFcovid.ReadJan2021Covid and not FFFFcovid.ReadApril2021Covid:
        if not FFFFcfg.UseFutures:
            FFFFpre.LengthFutures = 0
        print(
            startbold + "Number of Futures -- separate for each regular prediction " + str(FFFFpre.LengthFutures) + resetfonts)
        FFFFcfg.Usedaystart = False
    ...
    if len(FFFFcfg.InputSource) > 0:  # Reset Input Source
        ...
        FFFFpre.NewNormedDynamicPropertyTimeSeries = np.empty([FFFFpre.Num_Time, FFFFpre.Nloc, FFFFpre.NewNpropperTimeDynamic],
                                                              dtype=np.float32)
        ...
        for isource in range(0, len(FFFFcfg.InputSource)):
            if FFFFcfg.InputSource[isource] == 'Static':
                ...
                FFFFpre.NewNormedDynamicPropertyTimeSeries[:, :, countdynamic] = FFFFpre.NormedDynamicPropertyTimeSeries[:, :,
                                                                                 OlddynamicNumber]
                FFFFpre.NewPropertyNameIndex[countdynamic + FFFFpre.NewNpropperTimeStatic] = FFFFpre.PropertyNameIndex[
                    OlddynamicNumber + FFFFpre.NpropperTimeStatic]
                FFFFpre.NewPropertyAverageValuesPointer[countdynamic + FFFFpre.NewNpropperTimeStatic] = \
                FFFFpre.PropertyAverageValuesPointer[OlddynamicNumber + FFFFpre.NpropperTimeStatic]
                countdynamic += 1
...
def SetupPredictionsfromFutures(FFFFcfg):
    ...
    for ipred in range(0, FFFFpre.NumpredbasicperTime):
        if FFFFcfg.PredSource[ipred] == 'Dynamic':
            FFFFpre.Predictionbasicname[ipred] = FFFFpre.InputPropertyNames[
                FFFFcfg.PredSourceNumber[ipred] + FFFFpre.NpropperTimeStatic]
        else:
    ...
    print(startbold + 'Predictions Total ' + str(FFFFpre.Npredperseq) + ' Basic ' + str(
        FFFFpre.NumpredbasicperTime) + ' Of which futured are '
    ...
    for ipred in range(0, FFFFpre.NumpredbasicperTime):
        ...
        print(str(ipred) + ' Internal Property # ' + str(FFFFpre.PredictionAverageValuesPointer[ipred]) + ' ' +
              FFFFpre.Predictionname[ipred]
              + ' Weight ' + str(round(FFFFpre.Predictionwgt[ipred], 3)) + ' Day ' + str(
            FFFFpre.Predictionday[ipred]) + extrastring)

    for ifuture in range(0, FFFFpre.LengthFutures):
        for ipred in range(0, FFFFpre.NumpredbasicperTime):
            if FFFFcfg.FuturedPred[ipred] >= 0:
                FuturedPosition = FFFFpre.NumpredbasicperTime + FFFFpre.NumpredFuturedperTime * ifuture + FFFFcfg.FuturedPred[
                    ipred]
                FFFFpre.Predictionname[FuturedPosition] = FFFFpre.Predictionbasicname[ipred] + ' ' + FFFFpre.Futures[
                    ifuture].name
                ...
                print(
                    str(iprop) + ' Internal Property # ' + str(FFFFpre.PredictionAverageValuesPointer[FuturedPosition]) + ' ' +
    ...
    for ipred in range(0, FFFFpre.Npredperseq):
        ...
        for proppredval in range(0, 7):
            line += ' ' + FFFFpre.QuantityStatisticsNames[proppredval] + ' ' + str(
                round(FFFFpre.QuantityStatistics[jpred, proppredval], 3))
...
def SpecifyPredictions(FFFFcfg):
    ...
    for ipred in range(0, FFFFpre.NumpredbasicperTime):
        if FFFFpre.Predictionnametype[ipred] == 'Dynamic':
            FFFFpre.InputPredictionsbyTime[:, :, ipred] = FFFFpre.NormedDynamicPropertyTimeSeries[:, :,
                                                          FFFFpre.Predictionoldvalue[ipred]]
        else:
            FFFFpre.InputPredictionsbyTime[:, :, ipred] = FFFFpre.NormedCalculatedTimeSeries[:, :,
                                                          FFFFpre.Predictionoldvalue[ipred]]
            ...
            for itime in range(0, FFFFpre.Num_Time):
                ...
                if ActualTime >= FFFFpre.Num_Time:
                    for ipred in range(0, FFFFpre.NumpredbasicperTime):
                        ...
                        if Putithere >= 0:
                            FFFFpre.InputPredictionsbyTime[itime, :,
                            FFFFpre.NumpredbasicperTime + FFFFpre.NumpredFuturedperTime * ifuture + Putithere] = NaNall
                    atendveto += 1
                    ...
                    for ipred in range(0, FFFFpre.NumpredbasicperTime):
                        ...
                        if Putithere >= 0:
                            if FFFFpre.Predictionnametype[ipred] == 'Dynamic':
                                FFFFpre.InputPredictionsbyTime[itime, :,
                                FFFFpre.NumpredbasicperTime + FFFFpre.NumpredFuturedperTime * ifuture + Putithere] \
...
def SequencesfromInputs(FFFFcfg):
    ...
    FFFFpre.RawInputSequences = np.zeros(
        [FFFFcfg.Num_Seq + FFFFpre.Num_SeqExtra, FFFFpre.Nloc, FFFFpre.RawInputSeqDimension, FFFFpre.Npropperseq],
        dtype=np.float32)
    ...
    print(startbold + 'Sequences set from Time values Num Seq ' + str(FFFFpre.Num_SeqPred) + ' Time ' + str(
        FFFFpre.Num_Time) + ' FFFFcfg.Tseq ' + str(FFFFcfg.Tseq) + resetfonts)
...
def ReturnEncoding(numtofind, Typeindex, Typevalue, CosAnnualtimeEncoding, SinAnnualtimeEncoding, LinearoverLocationEncoding,
                   LinearovertimeEncoding):
...
def SetEncodings(FFFFcfg):
    ...
    for newpropinlist in range(0, numprop):
        ...
        a, b, c, d = ReturnEncoding(FFFFpre.Num_Time + FFFFpre.TFTExtraTimes, Typeindex,
                                    FFFFcfg.SpaceTimeEncodingPropValues[newpropinlist],
                                    CosAnnualtimeEncoding, SinAnnualtimeEncoding, LinearoverLocationEncoding,
                                    LinearovertimeEncoding)
        if c[0] != 'Dummy':
    ...
    for newpredinlist in range(0, numpred):
        ...
        a, b, c, d = ReturnEncoding(FFFFpre.Num_Time + FFFFpre.TFTExtraTimes, Typeindex,
                                    FFFFcfg.SpaceTimeEncodingPredValues[newpredinlist],
                                    CosAnnualtimeEncoding, SinAnnualtimeEncoding, LinearoverLocationEncoding,
                                    LinearovertimeEncoding)
        if c[0] != 'Dummy':
...
def AddTemporalSpatialEncoding(FFFFcfg):
    ...
    Numberpropaddons, PropIndex, PropNameMeanStd, PropMeanStd, PropArray, PropPosition, Numberpredaddons, PredIndex, PredNameMeanStd, PredArray, PredPosition = SetEncodings(
        FFFFcfg)
    ...
    for predaddons in range(0, Numberpredaddons):
        NewPredictionAverageValuesPointer[
            FFFFpre.Npredperseq + predaddons] = FFFFpre.NpropperTimeMAX + +Numberpropaddons + predaddons
        NewQuantityStatistics[FFFFpre.NpropperTimeMAX + Numberpropaddons + predaddons, :] = SetNewAverages(
            PredNameMeanStd[predaddons])

    FFFFpre.RawInputSequencesTOT = np.empty(
        [FFFFcfg.Num_Seq + FFFFpre.Num_SeqExtra + FFFFpre.TFTExtraTimes, FFFFpre.Nloc, FFFFpre.RawInputSeqDimension,
         FFFFpre.NpropperseqTOT], dtype=np.float32)
    flsize = np.float(FFFFcfg.Num_Seq + FFFFpre.Num_SeqExtra) * np.float(FFFFpre.Nloc) * np.float(
        FFFFpre.RawInputSeqDimension) * np.float(FFFFpre.NpropperseqTOT) * 4.0
    ...
    FFFFpre.RawInputPredictionsTOT = np.empty(
        [FFFFpre.Num_SeqPred + FFFFpre.TFTExtraTimes, FFFFpre.Nloc, FFFFpre.NpredperseqTOT], dtype=np.float32)
    ...
    if FFFFcfg.SymbolicWindows:
        ...
        FFFFpre.ReshapedSequencesTOT = np.reshape(FFFFpre.ReshapedSequencesTOT, (
        FFFFpre.Nloc, FFFFcfg.Num_Seq + FFFFpre.Num_SeqExtra + FFFFpre.TFTExtraTimes, FFFFpre.NpropperseqTOT))
    ...
    for iprop in range(0, FFFFpre.NpropperseqTOT):
        ...
        for proppredval in range(0, 7):
            line += ' ' + FFFFpre.QuantityStatisticsNames[proppredval] + ' ' + str(
                round(FFFFpre.QuantityStatistics[jprop, proppredval], 3))
        print(wraptotext(line, size=150))
    ...
    for ipred in range(0, FFFFpre.NpredperseqTOT):
        ...
        line = 'Prediction ' + str(ipred) + ' ' + FFFFpre.Predictionname[FFFFpre.PredictionNameIndex[ipred]] + ' ' + str(
            round(FFFFpre.Predictionwgt[ipred], 3))
        jpred = FFFFpre.PredictionAverageValuesPointer[ipred]
        line += ' Processing Root ' + str(FFFFpre.QuantityTakeroot[jpred])
        for proppredval in range(0, 7):
            line += ' ' + FFFFpre.QuantityStatisticsNames[proppredval] + ' ' + str(
...
def SetupNNSE(FFFFcfg):
    ...
    for ipred in range(0, FFFFpre.NpredperseqTOT):
        ...
        if (FFFFpre.Predictionname[FFFFpre.PredictionNameIndex[ipred]] == 'Constant') or (
                FFFFpre.Predictionname[FFFFpre.PredictionNameIndex[ipred]] == 'LinearSpace'):
...
def LocationBasedValidation(FFFFcfg):
    ...
    if FFFFcfg.LocationBasedValidation:
        if FFFFcfg.RestartLocationBasedValidation:
            ...
            print(' Validation restarted Fraction ' + str(
                round(FFFFcfg.LocationValidationFraction, 4)) + ' ' + FFFFcfg.RestartValidationSetRunName)
    ...
    if FFFFcfg.Earthquake:
        ...
        for iquake in range(0, FFFFeq.numberspecialeqs):
            ...
            line += str(iloc) + " " + str(jloc) + " " + str(kloc) + " " + str(round(FFFFeq.Specialmags[iquake], 1)) + ' ' + \
                    FFFFeq.Specialeqname[iquake]
            print(line)
        ...
        for iquake in range(0, FFFFeq.numberspecialeqs):
            iloc = FFFFeq.Specialxpos[iquake] + 60 * FFFFeq.Specialypos[iquake]
            line = str(iquake) + " Loc " + str(iloc) + " " + str(FFFFpre.MappedLocations[iloc]) + " Date " + str(
                FFFFeq.Specialdate[iquake]) + " " + str(FFFFeq.EQ_Numericaldate[iquake])
            line += " " + str(FFFFeq.PrimaryTrainingvetoquake[iquake]) + " " + str(FFFFeq.SecondaryTrainingvetoquake[iquake])
            line += " Val " + str(FFFFeq.PrimaryValidationvetoquake[iquake]) + " " + str(
                FFFFeq.SecondaryValidationvetoquake[iquake])
            print(line)
...
StartDate = np.datetime64(FFFFcfg.InitialDate).astype('datetime64[D]') + np.timedelta64(
    FFFFcfg.Tseq * FFFFcfg.Dailyunit + int(FFFFcfg.Dailyunit / 2), 'D')
if FFFFcfg.Earthquake:
    dayrange = np.timedelta64(FFFFcfg.Dailyunit, 'D')
...
def DLprediction(FFFFcfg, Xin, yin, DLmodel, modelflag, LabelFit=''):
    ...
    print(
        startbold + startred + current_time + ' DLPrediction Averages' + ' ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
    ...
    line += ' from loss function ' + str(round(closs, 6)) + ' TF version ' + str(round(dloss, 6)) + ' TFspec version ' + str(
        round(eloss, 6))
    print(wraptotext(line))
    print('Count ignoring NaN ' + str(round(weightedcount, 4)) + ' Counting NaN ' + str(round(weightedovercount, 4)), 70)
    print(' Unwgt Count no NaN ', totalcount, ' Unwgt Count with NaN ', overcount, ' Number Sequences ',
          FFFFpre.Nloc * FFFFcfg.Num_Seq)
    ...
    for i in range(0, FFFFpre.NpredperseqTOT):
        ...
        print(wraptotext(str(i) + ' ' + startbold + FFFFpre.Predictionname[
            FFFFpre.PredictionNameIndex[i]] + resetfonts + ' All Counts ' + str(
...
def ProduceSpatialQuakePlot(Observations, FitPredictions):
    current_time = timenow()
    print(
        startbold + startred + current_time + ' Produce Spatial FFFFcfg.Earthquake Plots ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
    dayindexmax = FFFFcfg.Num_Seq - FFFFeq.Plottingdelay
    Numdates = 4
    denom = 1.0 / np.float64(Numdates - 1)
    for plotdays in range(0, Numdates):
...
def EQrenorm(casesdeath, value):
    if FFFFcfg.Plotrealnumbers:
        ...
        newvalue = value / FFFFpre.QuantityStatistics[predaveragevaluespointer, 2] + FFFFpre.QuantityStatistics[
...
def FixedTimeSpatialQuakePlot(PlotTime, Observations, FitPredictions):
    ...
    print(startbold + startred + ' Spatial FFFFcfg.Earthquake Plots ' + Actualday.strftime(
        "%d/%m/%Y") + ' ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
...
def ProduceIndividualPlots(Observations, FitPredictions):
    current_time = timenow()
    print(
        startbold + startred + current_time + ' Produce Individual Plots ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
...
def bestandworst(Observations, FitPredictions):
    ...
    current_time = timenow()
    print(startbold + "\n" + current_time + " Best " + str(fips_b) + " " + FFFFpre.Locationname[bestindex] + " " +
          FFFFpre.Locationstate[bestindex] + ' ABS(error) ' +
    ...
    for topcities in range(0, 10):
        ...
        printstring = str(topcities) + ") " + str(FFFFpre.Locationfips[localindex]) + " " + FFFFpre.Locationname[
    ...
    print(startbold + "\n" + current_time + " Worst " + str(fips_w) + " " + FFFFpre.Locationname[worstindex] + " " +
          FFFFpre.Locationstate[worstindex] + ' ABS(error) ' +
    ...
    for badcities in range(FFFFpre.Nloc - 1, FFFFpre.Nloc - 11, -1):
        ...
        printstring = str(badcities) + ") " + str(FFFFpre.Locationfips[localindex]) + " " + FFFFpre.Locationname[
            localindex] + " ABS(error) Total " + str(round(testabserrorvalues[localindex], 4)) + " Components "
        for PredictedQuantity in range(0, FFFFpre.NumpredbasicperTime):
            printstring += ' ' + str(round(keepabserrorvalues[localindex, PredictedQuantity], 2))
        print(printstring)
...
def Location_summed_plot(selectedfuture, Observations, FitPredictions, fill=True, otherlabs=[], otherfits=[],
    ...
    current_time = timenow()
    print(wraptotext(
        startbold + startred + current_time + ' Location_summed_plot ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts))
                ...
                if selectedfuture == 0:
                    if FFFFpre.FuturedPointer[PlottedIndex] >= 0:
                        for ifuture in range(selectedfuture, FFFFpre.LengthFutures):
                            ...
                            predict[PlottedIndex, iValTrain, FFFFcfg.Num_Seq + ifuture] += normalizeforplot(PredictedPos, iloc,
                                                                                                            FitPredictions[
                                                                                                                itime, iloc,
                                                                                                                FFFFpre.FuturedPointer[
                                                                                                                    PlottedIndex] + jfuture])
                            for others in range(0, otherlen):
                                otherpredict[others, PlottedIndex, iValTrain, FFFFcfg.Num_Seq + ifuture] += normalizeforplot(
    ...
    for rowloop in range(0, neededrows):
        ...
        for kplot in range(0, 2):
            ...
            if FFFFcfg.UseRealDatesonplots:
                FFFFcfg.StartDate = np.datetime64(FFFFcfg.InitialDate).astype('datetime64[D]') + np.timedelta64(
                    FFFFcfg.Tseq * FFFFcfg.Dailyunit + math.floor(FFFFcfg.Dailyunit / 2), 'D')
            ...
            if selectedfuture > 0:
                ...
                if FFFFcfg.JournalSimplePrint:
                    ...
                    eachplt.text(0.05, 0.75, "FUTURE \n" + newyaxislabel, transform=eachplt.transAxes, color="black",
                                 fontsize=FFFFcfg.FONTSIZE, fontweight='bold')
            else:
        ...
        if Dumpplot and FFFFcfg.Dumpoutkeyplotsaspics:
            ...
            if NumberValTrainLoops == 1:
                VT = 'Full'
            plt.savefig(FFFFcfg.APPLDIR + '/Outputs/DLResults' + VT + str(PredictedPos) + FFFFcfg.RunName + '.png ',
                        format='png')
        mysavefig("")
        plt.show()
...
def plot_by_fips(fips, Observations, FitPredictions, dots=True, fill=True):
    ...
    print(startbold + startred + current_time + ' plot by location ' + str(Locationindex) + ' ' + str(fips) + ' ' +
          FFFFpre.Locationname[Locationindex] + ' ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
    ...
    for PredictedQuantity in range(0, FFFFpre.NumpredbasicperTime):
        for itime in range(0, FFFFcfg.Num_Seq):
            if np.math.isnan(Observations[itime, Locationindex, PredictedQuantity]):
                ...
                predict[PredictedQuantity, itime] = normalizeforplot(PredictedQuantity, Locationindex,
                                                                     FitPredictions[itime, Locationindex, PredictedQuantity])
        if FFFFpre.FuturedPointer[PredictedQuantity] >= 0:
            for ifuture in range(0, FFFFpre.LengthFutures):
                ...
                predict[PredictedQuantity, FFFFcfg.Num_Seq + ifuture] += normalizeforplot(PredictedQuantity, Locationindex,
                                                                                          FitPredictions[itime, Locationindex,
                                                                                          FFFFpre.FuturedPointer[
...
def plot_by_futureindex(selectedfuture, Observations, FitPredictions, fill=True, extrastring=''):
    ...
    print(startbold + startred + current_time + ' plot by Future Index ' + str(
        selectedfuture) + ' ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
...
def FindNNSE(Observations, FitPredictions, Label=''):
    ...
    current_time = timenow()
    print(wraptotext(
        startbold + startred + current_time + ' Calculate NNSE ' + Label + ' ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts))
    for NNSEpredindex in range(0, NumberNNSEcalc):
        ...
        print(wraptotext(line + 'NNSE ' + startbold + Label + ' ' + str(PredictedQuantity) + ' ' + FFFFpre.Predictionname[
            FFFFpre.PredictionNameIndex[PredictedQuantity]] + startred + ' Averaged ' +
    ...
    for NNSEpredindex in range(0, NumberNNSEcalc):
        ...
        if PredictedQuantity >= FFFFpre.NumpredbasicperTime:
            line = startred + 'Future ' + resetfonts
        print(wraptotext(line + startbold + Label + ' ' + str(PredictedQuantity) + ' ' + FFFFpre.Predictionname[
            FFFFpre.PredictionNameIndex[PredictedQuantity]] + resetfonts + ' MAE ' +
...
def debugfipsoutput(FFFFcfg, debugfips, FitPredictions, Xin, Observations):
    print(startbold + startred + 'debugfipsoutput for ' + str(
        debugfips) + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
    ...
    for iprop in range(0, FFFFpre.NpropperTimeStatic):
        ...
        line += startbold + FFFFpre.InputPropertyNames[FFFFpre.PropertyNameIndex[iprop]] + resetfonts + ' ' + str(
            round(val, 3)) + ' '
    print('\n'.join(wrap(line, 200)))
...
def DLprediction2F(FFFFcfg, Xin, yin, DLmodel, modelflag):
    ...
    SensitivityFitPredictions = np.zeros([FFFFcfg.Num_Seq, FFFFpre.Nloc, FFFFpre.NpredperseqTOT, 1 + something],
                                         dtype=np.float32)
    FRanges = np.full(FFFFpre.NpredperseqTOT, 1.0, dtype=np.float32)
    current_time = timenow()
    print(wraptotext(
        startbold + startred + 'DLPrediction2F ' + current_time + ' ' + FFFFcfg.RunName + FFFFcfg.RunComment + resetfonts))
    ...
    print(' Predict with ' + str(FFFFfit.Nloc_sample) + ' sequences per sample and batch size ' + str(
        FFFFfit.OuterBatchDimension))
    ...
    for Sensitivities in range(0, 1 + something):
        if Sensitivities == 0:  # BASIC unmodified run
            ...
            print(startbold + startred + 'Property ' + str(iprop) + ' ' + FFFFpre.InputPropertyNames[
        ...
        if Sensitivities == 0:
            ...
            lastline = ' Normed Mean ' + str(round(FFFFpre.QuantityStatistics[maxminplace, 5], 4))
            lineend = startbold + startred + 'Property ' + str(iprop) + ' ' + FFFFpre.InputPropertyNames[
        ...
        if SensitvitybyPrediction:
            for ipred in range(0, FFFFpre.NpredperseqTOT):
                print(str(round(Change[ipred], 5)) + ' GS ' + str(round(Goldstandard[ipred], 5))
                      + ' ' + str(ipred) + ' ' + FFFFpre.Predictionname[FFFFpre.PredictionNameIndex[ipred]] + ' wgt ' + str(
                    round(FFFFpre.Predictionwgt[ipred], 3)))
...
def setSeparateDLinput(model, Spacetime=False):
    ...
    if FFFFcfg.SymbolicWindows:
        ...
        InputSequences = np.empty([FFFFcfg.Num_Seq, FFFFcfg.TrainingNloc, FFFFcfg.Tseq, FFFFpre.NpropperseqTOT],
                                  dtype=np.float32)
        for iloc in range(0, FFFFcfg.TrainingNloc):
        ...
        if FFFFcfg.LocationValidationFraction > 0.001:  # Symbolic Windows false Calculate Validation
            ...
            if FFFFsctr.FullSetValidation:
                UsedValidationNloc = FFFFpre.Nloc
            ValInputSequences = np.empty([FFFFcfg.Num_Seq, UsedValidationNloc, FFFFcfg.Tseq, FFFFpre.NpropperseqTOT],
                                         dtype=np.float32)
            if FFFFsctr.FullSetValidation:
                for iloc in range(0, FFFFpre.Nloc):
...
class TensorFlowTrainingMonitor:
    def __init__(self, FFFFcfg):
        ...
        self.NameofRestoreReasons = ['Both Big Jump', 'Both Little Jump', 'Train Big Jump', 'Train Little Jump', 'Val Big Jump',
                                     'Val Little Jump', ' Failure Limit', ' self.NaN']
    ...
    def EpochEvaluate(self, epochcount, train_epoch, val_epoch, tfepochstep, recordtrainloss, recordvalloss):
        ...
        if np.math.isself.NaN(self.train_epoch) or np.math.isself.NaN(self.val_epoch):
            ...
            print(str(self.epochcount) + ' self.NaN Seen Reason ' + str(Failreason) + ' #succ ' + str(
...
def PrintLSTMandBasicStuff(FFFFcfg, model):
    ...
    if FFFFcfg.LocationBasedValidation:
        print(startbold + startred + " Location Based Validation with fraction " + str(
            FFFFcfg.LocationValidationFraction) + resetfonts)
        if FFFFcfg.RestartLocationBasedValidation:
            print(startbold + startred + " Using Validation set saved in " + FFFFcfg.RestartValidationSetRunName + resetfonts)
    print('\nAre futures predicted ' + str(FFFFcfg.UseFutures) + ' Custom Loss Pointer ' + str(
        FFFFcfg.CustomLoss) + ' Class weights used ' + str(FFFFfit.UseClassweights))
    ...
    for iprop in range(0, FFFFpre.NpropperseqTOT):
        line = startbold + startpurple + str(iprop) + ' ' + FFFFpre.InputPropertyNames[
            FFFFpre.PropertyNameIndex[iprop]] + resetfonts
        jprop = FFFFpre.PropertyAverageValuesPointer[iprop]
    ...
    print('\n' + startbold + labelline + resetfonts)
    for ipred in range(0, FFFFpre.NpredperseqTOT):
        line = startbold + startpurple + str(ipred) + ' ' + FFFFpre.Predictionname[
            FFFFpre.PredictionNameIndex[ipred]] + ' wgt ' + str(round(FFFFpre.Predictionwgt[ipred], 3)) + resetfonts + ' '
        jpred = FFFFpre.PredictionAverageValuesPointer[ipred]
        ...
        print(line)
    print('\n')
    print('FFFFcfg.Plotrealnumbers ' + str(FFFFcfg.Plotrealnumbers) + ' Root Cases Deaths ' + str(
        FFFFcovid.RootCasesDeaths) + ' FFFFcfg.JournalSimplePrint ' +
          str(FFFFcfg.JournalSimplePrint) + ' FFFFcfg.UseRealDatesonplots ' + str(
        FFFFcfg.UseRealDatesonplots) + ' Plot in DLPrediction2F ' + str(FFFFcfg.PlotinDL2F))

    if model == 0:
        print('Number of LSTMworkers ' + str(number_of_LSTMworkers))
        print('Number of epochs for each LSTMworker ' + str(FFFFlstm.LSTMepochs))
        print('LSTM Validation Fraction ' + str(FFFFlstm.LSTMvalidationfrac) + ' Used LSTM Validation Fraction ' + str(
            FFFFlstm.UsedLSTMvalidationfrac))
    ...
    print('LSTM Dropout Layer 1 ' + str(FFFFlstm.LSTMdropout1) + ' LSTM Recurrent Dropout Layer 1 ' + str(
        FFFFlstm.LSTMrecurrent_dropout1) + ' LSTM Dropout Layer >= 2 ' + str(
        FFFFlstm.LSTMdropout2) + ' LSTM Recurrent Dropout Layer >=2 ' + str(FFFFlstm.LSTMrecurrent_dropout2))
    print('Number of hidden LSTM nodes ' + str(FFFFlstm.number_LSTMnodes) + ' Is there a third LSTM layer? ' + str(
        FFFFlstm.LSTMThirdLayer))
...
class MyLSTMlayer(tf.keras.Model):
    ...
    def __init__(self, FFFFcfg, **kwargs):
        ...
        self.LSTM_1 = tf.keras.layers.LSTM(self.FFFFlstm.number_LSTMnodes,
                                           recurrent_dropout=self.FFFFlstm.LSTMrecurrent_dropout1,
                                           dropout=self.FFFFlstm.LSTMdropout1,
                                           activation=self.FFFFlstm.LSTMactivationvalue, return_sequences=True,
                                           recurrent_activation=self.FFFFlstm.LSTMrecurrent_activation)
        self.LSTM_2 = tf.keras.layers.LSTM(self.FFFFlstm.number_LSTMnodes,
                                           recurrent_dropout=self.FFFFlstm.LSTMrecurrent_dropout1,
                                           dropout=self.FFFFlstm.LSTMdropout1,
                                           activation=self.FFFFlstm.LSTMactivationvalue,
                                           return_sequences=self.FFFFlstm.LSTMThirdLayer,
                                           recurrent_activation=self.FFFFlstm.LSTMrecurrent_activation)
        if self.FFFFlstm.LSTMThirdLayer:
            self.LSTM_3 = tf.keras.layers.LSTM(self.FFFFlstm.number_LSTMnodes,
                                               recurrent_dropout=self.FFFFlstm.LSTMrecurrent_dropout1,
                                               dropout=self.FFFFlstm.LSTMdropout1,
                                               activation=self.FFFFlstm.LSTMactivationvalue, return_sequences=False,
                                               recurrent_activation=FFFFlstm.LSTMrecurrent_activation)
...
def RunLSTMCustomVersion(FFFFcfg):
    ...
    if FFFFfit.UseCustomfit and FFFFfit.UseClassweights:
        ...
        if FFFFfit.Restorefromcheckpoint:
            ...
            LSTMTFMonitor.SetCheckpointParms(mycheckpoint, FFFFcfg.CHECKPOINTDIR, FitRunName=FFFFcfg.RunName,
                                             Restoredcheckpoint=True,
                                             Restored_path=save_path, ValidationFraction=FFFFlstm.UsedLSTMvalidationfrac,
                ...
                if FFFFcfg.SymbolicWindows:
                    ...
                    for iloc in range(0, Numinbatch):
                        X_train_withSeq.append(
                            FFFFpre.ReshapedSequencesTOT[ilocarray[iloc], iseqarray[iloc]:iseqarray[iloc] + FFFFcfg.Tseq])
        ...
        # Print Fit details
        print(startbold + 'Times Symbolic-1 ' + str(round(Ctime1, 5)) + ' Symbolic-2 ' + str(round(Ctime3, 5)) + ' TF ' + str(
            round(Ctime2, 5)) + ' GarbageC ' + str(round(Ctime4, 5)) + resetfonts)
        print(
            startbold + 'Times Training ' + str(round(Ctime7, 5)) + ' Validation ' + str(round(Ctime5, 5)) + ' Monitor ' + str(
                round(Ctime6, 5)) + resetfonts)
    ...
    if FFFFcfg.SymbolicWindows:
        finalizeDL(FFFFcfg, myLSTMcustommodel, recordtrainloss, recordvalloss, FFFFlstm.UsedLSTMvalidationfrac,
                   FFFFpre.ReshapedSequencesTOT, FFFFpre.RawInputPredictionsTOT, 0)
    else:
        finalizeDL(FFFFcfg, myLSTMcustommodel, recordtrainloss, recordvalloss, FFFFlstm.UsedLSTMvalidationfrac,
                   FFFFpre.RawInputSequencesTOT, FFFFpre.RawInputPredictionsTOT, 0)
    return
...
if FFFFcfg.UseLSTMModel:
    ...
    if FFFFfit.standaloneLSTMrun or FFFFfit.ClassLSTMrun:
        print(wraptotext(
            startbold + startred + current_time + ' ' + runtype + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts))
    ...
    if FFFFfit.standaloneLSTMrun or FFFFfit.ClassLSTMrun:
        print(
            startbold + startpurple + 'LSTM run completed ' + runtype + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
        sys.exit(0)
    print(
        startbold + startpurple + current_time + ' UTC Start Hybrid Transformer run ' + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + resetfonts)
...
if FFFFcfg.UseScienceTransformerModel:
    ...
    print(
        "The maximum number of units presented to the Transformer which is fixed.It is FFFFcfg.Tseq times maximum number of locations simultaneously presented ",
        str(FFFFfit.max_d_sample))
    print(
        "The actual number of units presented to the Transformer for this batch.It is FFFFcfg.Tseq times  number of locations simultaneously presented in  this batch ",
        str(FFFFfit.max_d_sample))
    ...
    print("Number of locations times sequence window length in each sample presented to the Transformer ",
          str(FFFFfit.OuterBatchDimension))
...
def CalculateFullAttention(q, k, v, FFFFsctr.
...
if FFFFsctr.SeparateHeads:  # Spread out to save space
    ...
    for ihead in range(0, FFFFsctr.num_heads):
        matmul_qk = tf.matmul(q[:, ihead, :, :], k[:, ihead, :, :],
                              transpose_b=True)  # [Batch, ihead, FFFFfit.d_sample, depth] [Batch, ihead, (FFFFfit.d_sample, depth)T ]
    ...
    if FFFFsctr.ChopupMatrix:
        ...
        for choploop in range(0, FFFFsctr.ChopupNumber):
            ...
            attention_weights = tf.nn.softmax(scaled_attention_logits,
                                              axis=-1)  # scaled_attention_logits [Batch, FFFFsctr.num_heads, d_sampleCHOP, d_sampleCHOP]
            if mask is not None:
        ...
        matmul_qk = tf.matmul(q, k,
                              transpose_b=True)  # [Batch, FFFFsctr.num_heads, FFFFfit.d_sample, depth] [Batch, FFFFsctr.num_heads, (FFFFfit.d_sample, depth)T ]
        scaled_attention_logits = matmul_qk / tf.math.sqrt(
            dk)  # [Batch, FFFFsctr.num_heads, FFFFfit.d_sample, FFFFfit.d_sample]
        ...
        AttentionVectorfull = tf.matmul(attention_weights,
                                        v)  # [Batch, FFFFsctr.num_heads, FFFFfit.d_sample, FFFFfit.d_sample] [Batch, FFFFsctr.num_heads, FFFFfit.d_sample, d_v]

# Below done for FULL ATTENTION as only Attention whatever FFFFsctr.SeparateHeads
AttentionVectortemp = tf.transpose(AttentionVectorfull,
                                   perm=[0, 2, 1, 3])  # [Batch,  FFFFfit.d_sample, FFFFsctr.num_heads, d_v]
  ...
  """
    ...
    # End ONE WAY ATTENTION
        ...
        matmul_qk = tf.matmul(qtime, ktime,
                              transpose_b=True)  # [Batch, FFFFsctr.num_heads, FFFFfit.Nloc_sample, FFFFcfg.Tseq, depth] [Batch, FFFFsctr.num_heads, FFFFfit.Nloc_sample, (FFFFcfg.Tseq, depth)T ]
        scaled_attention_logits = matmul_qk / tf.math.sqrt(
            dk)  # [Batch, FFFFsctr.num_heads, FFFFfit.Nloc_sample, FFFFcfg.Tseq, FFFFcfg.Tseq]
        # add the mask to the scaled tensor.
        if mask is not None:
            ...
            timemask = tf.convert_to_tensor(FFFFsctr.GlobalTimeMask,
                                            dtype=tf.float32)  # [Batch, FFFFsctr.num_heads, FFFFfit.Nloc_sample, FFFFcfg.Tseq, FFFFcfg.Tseq]
        ...
        attention_weights = tf.nn.softmax(scaled_attention_logits,
                                          axis=-1)  # scaled_attention_logits [Batch, FFFFsctr.num_heads, FFFFfit.Nloc_sample, FFFFcfg.Tseq, FFFFcfg.Tseq]
        if mask is not None:
            attention_weights = tf.where(timemask > 0.2, 0.0, attention_weights)

        AttentionVector1time = tf.matmul(attention_weights,
                                         vtime)  # [Batch, FFFFsctr.num_heads, FFFFfit.Nloc_sample, FFFFcfg.Tseq, FFFFcfg.Tseq] [Batch, FFFFsctr.num_heads,  FFFFfit.Nloc_sample, FFFFcfg.Tseq, d_v] becomes [Batch, FFFFsctr.num_heads, FFFFfit.Nloc_sample, FFFFcfg.Tseq, depth]
        AttentionVector1temp = tf.transpose(AttentionVector1time, perm=[0, 2, 3, 1,
                                                                        4])  # [Batch,  FFFFfit.Nloc_sample, FFFFcfg.Tseq, FFFFsctr.num_heads, d_v]
        AttentionVector1 = tf.reshape(AttentionVector1temp,
                                      [q.shape[0], FFFFfit.d_sample, d_v * FFFFsctr.num_heads])  # restore shape
        ...
        if FFFFsctr.SpacewiseSecondAttention:
            ...
            qspace = tf.transpose(qtime, perm=[1, 0, 3, 2,
                                               4])  # [FFFFsctr.num_heads, Batch, FFFFcfg.Tseq, FFFFfit.Nloc_sample,  depth]
            kspace = tf.transpose(ktime, perm=[1, 0, 3, 2,
                                               4])  # [FFFFsctr.num_heads, Batch, FFFFcfg.Tseq, FFFFfit.Nloc_sample,  depth]
            vspace = tf.transpose(vtime,
                                  perm=[1, 0, 3, 2, 4])  # [FFFFsctr.num_heads, Batch, FFFFcfg.Tseq, FFFFfit.Nloc_sample,  d_v]
            if FFFFsctr.SeparateHeads:
                ...
                for ihead in range(0, FFFFsctr.num_heads):
                    ...
                    scaled_attention_logits = matmul_qk / tf.math.sqrt(
                        dk)  # [Batch, FFFFcfg.Tseq, FFFFfit.Nloc_sample, FFFFfit.Nloc_sample]
                    if mask is not None:
                        spacemask = tf.reshape(mask, [mask.shape[0], 1, FFFFfit.Nloc_sample, Nloc_sample])
                        scaled_attention_logits += (spacemask * -1e9)
                    attention_weights = tf.nn.softmax(scaled_attention_logits,
                                                      axis=-1)  # scaled_attention_logits [Batch,  FFFFcfg.Tseq, FFFFfit.Nloc_sample,  FFFFfit.Nloc_sample]
                    if mask is not None:
                    ...
                    HeadedAttentionVectorList.append(
                        OneheadAttentionVectorspace)  # [FFFFsctr.num_heads,Batch,  FFFFcfg.Tseq, FFFFfit.Nloc_sample,  depth]
                ...
                matmul_qk = tf.matmul(qspace, kspace,
                                      transpose_b=True)  # [FFFFsctr.num_heads,Batch,  FFFFcfg.Tseq, FFFFfit.Nloc_sample, depth] [FFFFsctr.num_heads, Batch, FFFFcfg.Tseq, (FFFFfit.Nloc_sample, depth)T ]
                scaled_attention_logits = matmul_qk / tf.math.sqrt(
                    dk)  # [FFFFsctr.num_heads, Batch, FFFFcfg.Tseq, FFFFfit.Nloc_sample, FFFFfit.Nloc_sample]
                ...
                attention_weights = tf.nn.softmax(scaled_attention_logits,
                                                  axis=-1)  # scaled_attention_logits [FFFFsctr.num_heads, Batch, FFFFcfg.Tseq, FFFFfit.Nloc_sample,  FFFFfit.Nloc_sample]
                if mask is not None:
                    attention_weights = tf.where(spacemask > 0.2, 0.0, attention_weights)
            ...
            AttentionVector2temp = tf.transpose(AttentionVector2space, perm=[1, 3, 2, 0,
                                                                             4])  # [Batch,  FFFFfit.Nloc_sample, FFFFcfg.Tseq, FFFFsctr.num_heads, d_v]
            AttentionVector2 = tf.reshape(AttentionVector2temp,
                                          [q.shape[0], FFFFfit.d_sample, d_v * FFFFsctr.num_heads])  # restore shape
        ...
        AttentionVector = tf.concat([AttentionVector1, AttentionVector2],
                                    -1)  # [Batch, FFFFfit.d_sample,2*d_v*FFFFsctr.num_heads]
...
class Active_QKV(tf.keras.layers.Layer):
    def __init__(self, d_intermediateqkv, d_finalqkv):
        ...
        self.FirstDenseqkv = tf.keras.layers.Dense(self.d_intermediateqkv,
                                                   activation=FFFFsctr.EncoderActivation)  # (batch_size, d_qkv, d_intermediateqkv)
...
def point_wise_feed_forward_network(FFFFsctr.


    d_EncoderLayer, FFFFsctr.d_ffn):
...
class EncodertoLSTMmerge(tf.keras.Model):
    ...
    def call(self, Originalinput, EncoderOutput, training=None):
        ...
        EncoderOutput = tf.reshape(EncoderOutput,
                                   [EncoderOutput.shape[0], FFFFfit.Nloc_sample, FFFFcfg.Tseq, FFFFsctr.d_EncoderLayer])

        if FFFFsctr.ReuseInputinEncoder:
            Originalinput = tf.reshape(Originalinput,
                                       [Originalinput.shape[0], FFFFfit.Nloc_sample, FFFFcfg.Tseq, Originalinput.shape[-1]])
...
def DLprediction2E(FFFFcfg, Xin, yin, DLmodel, modelflag):
    ...
    print(wraptotext(
        startbold + startred + 'DLPrediction2E Partial Attention ' + current_time + ' ' + FFFFcfg.RunName + FFFFcfg.RunComment + resetfonts))
    ...
    if FFFFcfg.SymbolicWindows:
        ...
        X_Transformerval = np.reshape(X_val,
                                      (FFFFfit.OuterBatchDimension, UsedValidationNloc * FFFFcfg.Tseq, FFFFpre.NpropperseqTOT))
    ...
    if FFFFcfg.SymbolicWindows:
        ...
        X_Transformertrainingflat2 = np.reshape(X_Transformertraining,
                                                (-1, FFFFcfg.TrainingNloc, FFFFcfg.Tseq, FFFFpre.NpropperseqTOT))
        ...
        for Trainingindex in range(0, FFFFfit.OuterBatchDimension):
            ...
            for iloc_sample in range(0, FFFFfit.Nloc_sample):
                ...
                if FitRanges_PartialAtt[SeqLocal, LocLocal, 0, 0] < 0.1:
                    ...
                    FitRanges_PartialAtt[SeqLocal, LocLocal, :, 3] = np.maximum(FitRanges_PartialAtt[SeqLocal, LocLocal, :, 3],
                                                                                yyhat)
                    FitRanges_PartialAtt[SeqLocal, LocLocal, :, 4] = np.minimum(FitRanges_PartialAtt[SeqLocal, LocLocal, :, 4],
                                                                                yyhat)
...
def DLprediction2D(FFFFcfg, Xin, yin, DLmodel):
    ...
    print(wraptotext(
        startbold + startred + 'DLPrediction2D ' + current_time + ' ' + FFFFcfg.RunName + FFFFcfg.RunComment + resetfonts))
...
def printloss(name, mean, var, FFFFsctr.
...
def DLprediction2(FFFFcfg, Xin, yin, DLmodel):
    ...
    print(wraptotext(
        startbold + startred + 'DLPrediction2 ' + current_time + ' ' + FFFFcfg.RunName + FFFFcfg.RunComment + ' ' + str(
    ...
    for TimeScopeLoop in range(0, NumberScopes):
        ...
        plt.title(FFFFcfg.RunComment + ' ' + FFFFcfg.RunName + ' Time Scope ' + str(localtimeinterval) + ' Mean ' + str(
            round(meanvalue2, 6)))
        ...
        if FFFFcfg.LocationBasedValidation:
            ...
            plt.title(FFFFcfg.RunComment + ' ' + FFFFcfg.RunName + ' Time Interval ' + str(localtimeinterval) + ' Mean ' + str(
                round(meanvalue4, 6)))
            ...
            print(startbold + 'Time Interval ' + str(localtimeinterval) + ' Train ' + str(round(meanvalue3, 6)) + ' std ' + str(
                round(v3, 6))
...
def DLprediction2(FFFFcfg, Xin, yin, DLmodel):
    ...
    current_time = timenow()
    print(
        startbold + startpurple + current_time + FFFFcfg.RunName + ' ' + FFFFcfg.RunComment + ' DLprediction2B Summarize Full Sampling Results' + resetfonts)
    print('Times ' + str(round(Ctime1, 5)) + ' ' + str(round(Ctime3, 5)) + ' TF ' + str(round(Ctime2, 5)))
    ...
    print(wraptotext(
        FFFFcfg.RunComment + ' ' + FFFFcfg.RunName + '  DLprediction2B Best Basic Error% ' + str(round(100.0 * bestvalue1, 4)) +
    ...
    for i in range(0, FFFFpre.NpredperseqTOT):
        print('RMSE % ' + str(i) + ' ' + FFFFpre.Predictionname[FFFFpre.PredictionNameIndex[i]] + ' ' + str(
            round(count[i], 0)) + ' ' +
    ...
    current_time = timenow()
    print(wraptotext(
        startbold + startpurple + current_time + ' ' + FFFFcfg.RunName + ' These FULL plots with uncertainties from DLprediction2B '
    ...
    otherlabs2 = ['Max', 'Min']
    otherfits2 = np.array(
        [np.subtract(FitRanges[:, :, :, 3], FitRanges[:, :, :, 1]), np.subtract(FitRanges[:, :, :, 4], FitRanges[:, :, :, 1])])
...
def DLprediction3(yin, FitPredictions, LabelFit, Dumpplot=False):
    ...
    print(wraptotext(
        FFFFcfg.RunName + ' DLPrediction3 ' + LabelFit + ' Weighted sum over predicted values ' + str(round(weightedrmse1, 7))
    ...
    for i in range(0, FFFFpre.NpredperseqTOT):
        ...
        print(wraptotext(str(i) + ' ' + startbold + FFFFpre.Predictionname[
            FFFFpre.PredictionNameIndex[i]] + resetfonts + ' All Counts ' + str(round(countbyclass[i, 0], 0)) + ' '
                         + str(round(100.0 * RMSEbyclass2[i], 4)) + ' ' + str(round(100.0 * RelEbyclass[i], 4)) + ' ' + str(
            round(100.0 * SummedEbyclass[i], 4)) + line))
        extracomments.append(
            ['Loss Coeffs F=' + str(round(RTRAIN[0], 5)) + ' S=' + str(round(RTRAIN[1], 5)) + ' E=' + str(round(RTRAIN[2], 5)),
...
def RunScienceTransformer(FFFFcfg):
    ...
    if FFFFcfg.LocationBasedValidation:
        ...
        if FFFFcfg.SymbolicWindows:
            ...
            X_Transformertraining = np.reshape(X_predict,
                                               (FFFFfit.OuterBatchDimension, FFFFfit.d_sample, FFFFpre.NpropperseqTOT))
        y_Transformertraining = np.reshape(y_predict,
                                           (FFFFfit.OuterBatchDimension, FFFFfit.Nloc_sample, FFFFpre.NpredperseqTOT))
        Spacetime_Transformertraining = np.reshape(Spacetime_predict, (FFFFfit.OuterBatchDimension, FFFFfit.Nloc_sample))
        if FFFFsctr.UsedTransformervalidationfrac > 0.001:
            if FFFFcfg.SymbolicWindows:
                X_Transformerval = np.reshape(X_val, (FFFFfit.OuterBatchDimension, UsedValidationNloc))
        ...
        Spacetime_Transformertrainingplusval = np.reshape(Spacetime_Transformertrainingplusval,
                                                          (FFFFfit.OuterBatchDimension, FFFFfit.Nloc_sample))
        y_Transformertrainingplusval = np.reshape(y_Transformerdetailed,
                                                  (FFFFfit.OuterBatchDimension, FFFFfit.Nloc_sample, FFFFpre.NpredperseqTOT))
        ...
        if FFFFsctr.UsedTransformervalidationfrac > 0.001:
            ...
            print(FFFFcfg.RunName + " Validation samples ", Total_val, " Training samples ", Total_all - Total_val,
                  " from sequences")
            if Total_val == 0:
                FFFFsctr.UsedTransformervalidationfrac = 0.0
        ...
        y_predict = np.reshape(y_Transformertrainingplusval,
                               (FFFFfit.OuterBatchDimension * FFFFfit.Nloc_sample, FFFFpre.NpredperseqTOT))
                    ...
                    if FFFFcfg.SymbolicWindows:
                        ...
                        for iloc in range(0, NumTOTAL):
                            X_valbatch_withSeq.append(
                                FFFFpre.ReshapedSequencesTOT[ilocarray[iloc], iseqarray[iloc]:iseqarray[iloc] + FFFFcfg.Tseq])
                        X_valbatch_withSeq = np.array(X_valbatch_withSeq)
                        X_valbatch_withSeq = np.reshape(X_valbatch_withSeq,
                                                        (Numinbatch, FFFFfit.d_sample, FFFFpre.NpropperseqTOT))
                        Time = SetSpacetime(FFFFcfg, np.reshape(iseqarray, [Numinbatch, -1]))
                        StopWatch.stop('label3')
                        Ctime3 += StopWatch.get('label3', digits=5)
                        StopWatch.start('label2')
    ...
    def finalanalysis(FFFFcfg, myScienceTransformermodel, recordtrainloss, recordvalloss, LabelFit, summary):
        ...
        if FFFFcfg.SymbolicWindows:
            finalizeDL(FFFFcfg, myScienceTransformermodel, recordtrainloss, recordvalloss,
                       FFFFsctr.UsedTransformervalidationfrac,
    ...
    if FFFFcfg.UseScienceTransformerModel:
        ...
        print("TimeShufflingOnly: if False shuffle over space and Time each batch; True just shuffle over time ",
              str(FFFFsctr.TimeShufflingOnly))
        print("Batch size of stochastic gradient descent FFFFsctr.Transformerbatch_size ", str(FFFFsctr.Transformerbatch_size))
        if not FFFFcfg.LocationBasedValidation:
            print(startbold + startred + "Fraction used for a validation dataset ", str(FFFFsctr.Transformervalidationfrac),
                  " No location based Validation" + resetfonts)
        print('FFFFsctr.FullSetValidation ' + str(FFFFsctr.FullSetValidation))
        print('Sample size FFFFfit.IncreaseNloc_sample ' + str(
            FFFFfit.IncreaseNloc_sample) + ' FFFFfit.DecreaseNloc_sample ' + str(FFFFfit.DecreaseNloc_sample))
        ...
        print("Number of Attention Heads which must exactly divide FFFFsctr.d_model, FFFFsctr.num_heads ",
              str(FFFFsctr.num_heads))
        ...
        print("Size of feedforward network in each encoder layer. It appears to be 4 * FFFFsctr.d_model, FFFFsctr.d_ffn ",
              str(FFFFsctr.d_ffn))
        ...
        print(startbold + startred + "Defines masking used; = 0 none; =1 mask the future FFFFsctr.MaskingOption ",
              str(FFFFsctr.MaskingOption) + resetfonts)
        ...
        print(' FFFFsctr.SpacewiseSecondAttention First attention is Time in sequence Second is Space or Full ' + str(
            FFFFsctr.SpacewiseSecondAttention))
...
"""
    ...
    if FFFFcfg.UseTFTModel:
        ...
        for ilocation in range(0, FFFFpre.Nloc):
            ...
            locname = FFFFpre.Locationname[FFFFpre.LookupLocations[ilocation]] + ' ' + FFFFpre.Locationstate[
                FFFFpre.LookupLocations[ilocation]]
            if locname == "":
        ...
        for ipred in range(0, FFFFpre.NpredperseqTOT):
            ...
            line = startbold + startpurple + str(ipred) + ' ' + FFFFpre.Predictionname[
                FFFFpre.PredictionNameIndex[ipred]] + ' ' + text + resetfonts + ' Futured ' + str(fp) + ' '
...
"""
                    ...
                    for seqnumber in range(0, self.Num_Seq1):
                        ...
                        for ipred in range(0, FFFFpre.NpredperseqTOT):
                            ...
                            if ActualTFTSeq <= self.MaxTFTSeq:
                                for ifuture in range(0, PredictionCalcLength[ipred]):
                                    ...
                                    if predstatus == 3:
                                        newvalue = self.ReshapedPredictionsTOT[ilocation, ActualTFTSeq, kpred] / \
                                                   FFFFpre.QuantityStatistics[predaveragevaluespointer, 2] + \
                                                   FFFFpre.QuantityStatistics[predaveragevaluespointer, 0]
                                    else:
                                ...
                                value = (value - FFFFpre.QuantityStatistics[actualpredaveragevaluespointer, 0]) * \
                                        FFFFpre.QuantityStatistics[actualpredaveragevaluespointer, 2]
    ...
    def VisualizeTFT(TFTmodel, output_map):
        ...
        FitPredictions = DLprediction(FFFFcfg, FFFFpre.ReshapedSequencesTOT, FFFFpre.RawInputPredictionsTOT, MyFFFFWNPFLink,
                                      modelflag, LabelFit='TFT')
...
"""
  ...
  """
        ...
        # EAGER@tf.function
        def __init__(self, n_head, FFFFsctr.

            d_model, dropout, MHAname = 'Default', ** kwargs):
    ...
    def __init__(self, **kwargs):
        ...
        if myTFTTools.TFTdefaultLSTM:
            ...
            self.TFTLSTMEncoder = TFTLSTMLayer(myTFTTools.TFTLSTMEncoderSecondLayer, myTFTTools.TFTLSTMEncoderThirdLayer,
                                               ...
                                               myTFTTools.TFTLSTMEncoderdropout1, myTFTTools.TFTLSTMEncoderrecurrent_dropout1,
                                               TFTreturn_state=True, LSTMname='ControlEncoder')
            self.TFTLSTMDecoder = TFTLSTMLayer(myTFTTools.TFTLSTMDecoderSecondLayer, myTFTTools.TFTLSTMDecoderThirdLayer,
                                               ...
                                               myTFTTools.TFTLSTMDecoderdropout1, myTFTTools.TFTLSTMDecoderrecurrent_dropout1,
                                               TFTreturn_state=False, LSTMname='ControlDecoder')
...
def finalizeTFTDL(FFFFcfg, ActualModel, recordtrainloss, recordvalloss, validationfrac, test_datacollection, modelflag,
                  LabelFit=''):
    FFFFfit = FFFFcfg.FFFFfit
...
def RunTFTCustomVersion(FFFFcfg):
    ...
    if FFFFfit.Restorefromcheckpoint:
        ...
        print(startbold + 'Network restored from ' + save_path + '\nLoss ' + str(round(recordtrainloss[trainlen - 1], 7))
              + extrainfo + ' Epochs ' + str(tfepochstep.numpy()) + resetfonts)
        TFTTrainingMonitor.SetCheckpointParms(mycheckpoint, FFFFcfg.CHECKPOINTDIR,
                                              FFFFcfg.RunName = FFFFcfg.RunName, Restoredcheckpoint = True,
        Restored_path = save_path, ValidationFraction = FFFFfit.AnyOldValidation, SavedTrainLoss = SavedTrainLoss,
        SavedValLoss = SavedValLoss)
        else:
        TFTTrainingMonitor.SetCheckpointParms(mycheckpoint, FFFFcfg.CHECKPOINTDIR,
                                              FFFFcfg.RunName = FFFFcfg.RunName, Restoredcheckpoint = False,
        ...
        if FFFFfit.AnalysisOnly:
            if FFFFcfg.OutputNetworkPictures:
                ...
                tf.keras.utils.plot_model(myTFTcustommodel.myTFTFullNetwork.build_graph([FFFFcfg.Tseq, FFFFpre.NpropperseqTOT]),
                                          ...
                                          expand_nested=True)
            if myTFTTools.TFTSymbolicWindows:
                finalizeTFTDL(FFFFcfg, myTFTcustommodel, recordtrainloss, recordvalloss, FFFFfit.AnyOldValidation,
                              TFTtest_datacollection, 2, LabelFit='Custom TFT Fit')
            else:
                finalizeTFTDL(FFFFcfg, myTFTcustommodel, recordtrainloss, recordvalloss, FFFFfit.AnyOldValidation,
                              TFTtest_datacollection, 2, LabelFit='Custom TFT Fit')
                return
      ...
      '''
        ...
        if FFFFcfg.OutputNetworkPictures:
            ...
            tf.keras.utils.plot_model(myTFTcustommodel.myTFTFullNetwork.build_graph([FFFFcfg.Tseq, FFFFpre.NpropperseqTOT]),
                                      ...
                                      expand_nested=True)
        if myTFTTools.TFTSymbolicWindows:
            finalizeTFTDL(myTFTcustommodel, recordtrainloss, recordvalloss, FFFFfit.AnyOldValidation, TFTtest_datacollection, 2,
    ...
    def PrintTFTBasicStuff(FFFFcfg):
        ...
        if FFFFcfg.LocationBasedValidation:
            ...
            if FFFFcfg.RestartLocationBasedValidation:
                print(
                    startbold + startred + " Using Validation set saved in " + FFFFcfg.RestartValidationSetRunName + resetfonts)
        print('\nAre futures predicted ' + str(FFFFcfg.UseFutures) + ' Custom Loss Pointer ' + str(
            FFFFcfg.CustomLoss) + ' Class weights used ' + str(FFFFfit.UseClassweights))
